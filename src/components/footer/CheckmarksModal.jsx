export const CheckmarksModal = () => {
    return <>
        <div className="modal modal-lg fade" id="checkmarksModalCenter" tabIndex="-1" role="dialog" aria-labelledby="checkmarksModalCenterTitle" aria-hidden="true">
            <div className="modal-dialog modal-dialog-centered" role="document">
                <div className="modal-content" id="checkmark-modal-content">
                    ...
                    <div className="modal-body modalCheckmarks">
                        ...
                        <ul>
                            <li style={{ marginLeft: 10 }}>✅Links - The links (choose whatever links you want. at least 2) should be displayed as unordered list items and clicking on a link will open it in a new tab.</li>
                            <li style={{ marginLeft: 10 }}>✅Copyright - It will display "copyright 2024". The year is dynamically determined.</li>
                        </ul>
